...
int x = 140; // number of grid points in radial direction (across diameter)
int y = 20; // number of grid points in film thickness

const double lx = 7.0; // diameter of circular disc (in m)
...
// double v_vel = 0.05;
const double u_lid = 0.01; // velocity of top squeeze plate in downward direction
